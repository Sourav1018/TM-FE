...
export default function ComponentsPage() {
  return (
    <div className="bg-background">
      ...
      {/* Main content */}
      <div className="flex flex-col gap-12 p-6 md:p-12 bg-background">
        ...
        {/* Buttons section */}
        <div className="flex flex-wrap gap-4 items-center p-6 border rounded-3xl bg-surface-container-low">
        ...
        {/* Card section */}
        <Card className="w-80 rounded-[2rem] border-none bg-surface-container-low p-2">
