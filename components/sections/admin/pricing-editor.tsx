  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col justify-center items-center rounded-lg bg-linear-to-br from-primary/5 to-emerald-500/5 p-12 border border-primary/10">
          <div className="relative">
            ...
            <Card className="relative bg-white rounded-lg shadow-2xl p-10 border border-border/40 w-75 space-y-8 transform transition-transform hover:scale-105 duration-500">
          ...
          <p className="mt-12 text-center text-sm font-medium text-muted-foreground leading-relaxed max-w-70">
