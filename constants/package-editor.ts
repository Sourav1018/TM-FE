export const PACKAGE_EDITOR_STEPS = [
  ...
  { id: 4, label: "Gallery", nextLabel: "Next Step: Facilities" },
  { id: 5, label: "Facilities", nextLabel: "Next Step: Final Review" },
  { id: 6, label: "Final Review", nextLabel: "Publish Package" },
]
